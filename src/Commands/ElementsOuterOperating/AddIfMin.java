...
public class AddIfMin implements CommandInterface {
    ...
    public void execute(String[] args) {
        ...
        try {
            if (collection.isEmpty() || newMarine.getChapter().getMarinesCount() < Collections.min(collection, Comparator.comparingInt(m -> m.getChapter().getMarinesCount())).getChapter().getMarinesCount()) {
